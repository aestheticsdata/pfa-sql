...
var WeeklyCharts = function () {
    ...
    var url = "/spendings/charts?userID=" + user.id + "&from=" + dateRange.from + "&to=" + dateRange.to;
    var intl = react_intl_1.useIntl();
    return (<StyledChartsContainer_1.default>
      <Charts_1.default url={url} currency={user.baseCurrency} title={intl.formatMessage(__assign({}, messages_1.default.amountByCategoriesWeeklyChartsTitle))} periodType={widgetHeaderConstants_1.WEEKLY}/>
    </StyledChartsContainer_1.default>);
};
exports.default = WeeklyCharts;

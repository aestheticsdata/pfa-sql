...
exports.onDeleteCategory = void 0;
...
function onDeleteCategory(payload) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 4, , 5]);
                return [4 /*yield*/, effects_1.call(requestHelper_1.privateRequest, "/categories/" + category.ID, {
                        method: 'DELETE',
                    })];
            case 2:
                _a.sent();
...
function defaultSaga() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeLatest(constants_1.DELETE_CATEGORY, onDeleteCategory)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }

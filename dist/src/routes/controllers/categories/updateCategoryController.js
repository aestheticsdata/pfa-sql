...
module.exports = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, categoryID, name, color, userID, categories, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, categoryID = _a.ID, name = _a.name, color = _a.color, userID = _a.userID;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 4, , 5]);
                return [4 /*yield*/, prisma.categories.update({
                        where: { ID: categoryID },
                        data: {
                            name: name,
                            color: color,

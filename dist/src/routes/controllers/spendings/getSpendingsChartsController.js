...
var dateFormatter = require('./helpers/dateFormatter');
module.exports = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, from, to, chartsStats, e_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = dateFormatter(req), from = _a.from, to = _a.to;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
            ...
            case 3:
                e_1 = _b.sent();
                res.status(500).json({ msg: 'error while getting charts : ', e: e_1 });
                return [3 /*break*/, 4];

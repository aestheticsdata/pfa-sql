...
var uploadPath = process.cwd() + '/src/invoicesUpload/';
...
var storage = multer.diskStorage({
    destination: function (req, file, cb) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userDir = uploadPath + req.body.userID;
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, 5, 6]);
                        return [4 /*yield*/, promises_1.access(userDir)];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 3:
                        e_1 = _a.sent();
                        return [4 /*yield*/, promises_1.mkdir(uploadPath + req.body.userID)];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 5:
    ...
    filename: function (req, file, cb) {
        ...
        var _a = req.body, itemType = _a.itemType, date = _a.date, dateFrom = _a.dateFrom, label = _a.label;
        var fileName = '';
        switch (itemType) {
            case 'recurring':
...
module.exports = multer({ storage: storage, limits: { fileSize: 32097152 } });
